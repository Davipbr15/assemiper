                ...
                {assc.map((ascData, index) => {
                  return (
                    <tr key={index} className="group bg-assemiperBlack font-bold border-b break-all transition duration-300 ease-in-out hover:bg-red-700">
                      ...
                      <td className="tg-dg7a group-hover:bg-slate-200 text-center"><button name="imprimirAsc" onClick={() => getPrintAssociate(ascData._id)} className="hover:scale-125 transition  duration-150 linear text-black bg-opacity-50 rounded-full p-2"><i className="bi bi-printer"></i></button></td>
